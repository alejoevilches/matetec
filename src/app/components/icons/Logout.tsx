...
export default function Logout({onClick}: {onClick:()=>void}) {
    return (
        <svg onClick={onClick} width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M13 12L21 12" stroke="#323232" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
